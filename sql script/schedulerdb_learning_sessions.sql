...
CREATE TABLE `learning_sessions` (
  ...
  `pre_duration` time DEFAULT NULL,
  ...
  CONSTRAINT `learning_sessions_ibfk_1` FOREIGN KEY (`learning_group_id`) REFERENCES `learning_groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-09-22 14:48:37
